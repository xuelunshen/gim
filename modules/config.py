...
_CN.LOFTR.MATCH_COARSE.TRAIN_ZEROSHOT_NUM = 2048  # training tricks: save GPU memory
_CN.LOFTR.MATCH_COARSE.TRAIN_PAD_NUM_GT_MIN = 100  # training tricks: avoid DDP deadlock
